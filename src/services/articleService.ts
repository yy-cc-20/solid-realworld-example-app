...
import { Pagination, ArticleFilter, CreateArticleRequest, UpdateArticleRequest, ArticleList } from '../interfaces';
import { user } from '../stores/userStore';
import { authHeader, isAuthenticated } from './authService';
...
export async function getArticleList(ArticleFilter: ArticleFilter, articlePagination: Pagination): Promise<ArticleList | undefined> {
    ...
    var apiUrl = import.meta.env.API_URL + '/articles' + '?limit=' + articlePagination.limit + '&offset=' + articlePagination.offset;
...
async function feedArticleList(articlePagination: Pagination) {
    var apiUrl = import.meta.env.API_URL + '/articles/feed' + '?limit=' + articlePagination.limit + '&offset=' + articlePagination.offset;
